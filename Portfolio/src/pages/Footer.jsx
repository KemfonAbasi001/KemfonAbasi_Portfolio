...
function Footer() {
  return (
    <>
      <footer id="footer" className="relative w-full py-60 flex justify-center items-center bg-[white] dark:bg-[#0a0a0b]">
        <div className="w-[90%] flex-col pb-40 fixed bottom-0">

        <div className="w-full flex gap-17 flex-col">
          <a href="#" className="flex self-end py-3 px-10 bg-black text-white dark:bg-[#E5E5E5] dark:text-[#111114] cursor-pointer font-fira ">Hire Me</a>
          <div className="flex flex-col gap-17">
             <h2 className="font-fira text-[12.25px] text-black dark:text-[#B5B5B5]">
               ...
               <div className="flex gap-3 w-fit flex-wrap justify-center">
                <a href="" className="w-12.5 h-12.5 rounded-2xl border border-solid border-[#2a2a2e] cursor-pointer flex items-center justify-center bg-transparent" aria-label="X / Twitter">
                  <svg className="w-6.75 h-6.75 fill-black dark:fill-[#e5e5e5]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
