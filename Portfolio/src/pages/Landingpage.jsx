      ...
      <section className="w-full pt-40 pb-24 flex justify-center bg-[#f4f4f4] dark:bg-[#0a0a0b]">
        <div className="w-[90%] text-center flex flex-col items-center">
          ...
          <div
            ...
            className="font-fira py-0.7 px-3 lg:py-1 lg:px-3.5 rounded-full flex gap-2 items-center lg:text-[12.5px] text-[14px] bg-inherit dark:bg-[#111114] border border-solid border-[#9b9b9b] dark:border-[#2a2a2e] text-[#1c1c1c] dark:text-[#B5B5B5] cursor-pointer"
          >
