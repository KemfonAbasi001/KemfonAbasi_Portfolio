...
function LandingPageSection() {
  ...
  return (
    <>
      <section className="w-full pt-40 pb-24 flex justify-center bg-[#0a0a0b]">
        <div className="w-[90%] text-center flex flex-col items-center">
            ...
            Open to work</a>
            <h1 className="font-goggle text-[2.7rem] leading-13.75 font-semibold text-[#E5E5E5] tracking-tight mt-4 mb-3">Build with KemfonAbasi_</h1>
