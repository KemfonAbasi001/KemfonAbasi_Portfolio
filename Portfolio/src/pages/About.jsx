      ...
      >
        <div className="w-[90%] flex flex-col gap-15 lg:flex-row lg:items-center">
          ...
          <div ref={textRef} className="flex flex-col gap-4 lg:w-[98%]">
            <h1 className="text-[36px] lg:text-[40px] leading-tight text-[#0f0f0f] dark:text-[#E5E5E5] font-semibold">
              About Me
            </h1>
            <p className="text-[#1c1c1c] dark:text-[#B5B5B5] leading-7 text-[15.7px] lg:text-[18px]">
